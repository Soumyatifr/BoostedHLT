...
class GlobalParticleTransformerAK15TagInfoProducer : public edm::stream::EDProducer<> {
public:
  explicit GlobalParticleTransformerAK15TagInfoProducer(const edm::ParameterSet &);
  ~GlobalParticleTransformerAK15TagInfoProducer() override;
...
const std::vector<std::string> GlobalParticleTransformerAK15TagInfoProducer::jet_features_{
    "jet_pt_log",
    "jet_eta",
    "jet_mass_log",
    "jet_energy_log",
};
const std::vector<std::string> GlobalParticleTransformerAK15TagInfoProducer::charged_particle_features_{
    "cpfcandlt_puppiw",
    "cpfcandlt_hcalFrac",
    "cpfcandlt_VTX_ass",
...
const std::vector<std::string> GlobalParticleTransformerAK15TagInfoProducer::neutral_particle_features_{
    "npfcand_puppiw",
    "npfcand_hcalFrac",
    "npfcand_isGamma",
...
const std::vector<std::string> GlobalParticleTransformerAK15TagInfoProducer::sv_features_{
...
GlobalParticleTransformerAK15TagInfoProducer::GlobalParticleTransformerAK15TagInfoProducer(
...
void GlobalParticleTransformerAK15TagInfoProducer::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
  // pfGlobalParticleTransformerAK15TagInfos
  edm::ParameterSetDescription desc;
  desc.add<double>("jet_radius", 1.5); 
  ...
  descriptions.add("pfGlobalParticleTransformerAK15TagInfos", desc);
}

void GlobalParticleTransformerAK15TagInfoProducer::produce(edm::Event &iEvent, const edm::EventSetup &iSetup) {
...
void GlobalParticleTransformerAK15TagInfoProducer::fillJetFeatures(DeepBoostedJetFeatures &fts, const reco::Jet &jet) {
  // reserve space
  for (const auto &name : jet_features_) {
    fts.reserve(name, 1);
  }
...
void GlobalParticleTransformerAK15TagInfoProducer::fillParticleFeatures(DeepBoostedJetFeatures &fts,
                                                                       const reco::Jet &jet) {
...
void GlobalParticleTransformerAK15TagInfoProducer::fillSVFeatures(DeepBoostedJetFeatures &fts, const reco::Jet &jet) {
...
DEFINE_FWK_MODULE(GlobalParticleTransformerAK15TagInfoProducer);
